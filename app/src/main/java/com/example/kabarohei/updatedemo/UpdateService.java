...
public class UpdateService extends Service {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        updateNotification.contentView.setProgressBar(R.id.progressBar,100,0,false);
                            ...
                            if (is != null) {
                                ...
                                while ((readsize = is.read(buffer)) > 0) {
                                    ...
                                    if ((count == 0)
                                        ...
                                        updateNotification.contentView.setProgressBar(R.id.progressBar,100,(int)(100*downloadSize/totalSize),false);
